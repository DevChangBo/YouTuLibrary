...
import com.cbjess.arms.integration.lifecycle.ActivityLifecycleable;
...
import static com.cbjess.arms.utils.ThirdViewUtil.convertAutoView;
...
//                hideBottomUIMenu();
     ...
     * 如果返回false,那意味着这个Activity不需要绑定Fragment,那你再在这个Activity中绑定继承于 {@link com.cbjess.arms.base.BaseFragment} 的Fragment将不起任何作用
     *
     * @return
     */
    @Override
